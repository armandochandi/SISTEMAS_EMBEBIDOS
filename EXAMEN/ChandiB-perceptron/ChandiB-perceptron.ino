...
for(fil=0;fil<120;fil++){ //numero de datos de entrada   
    sumatoria[fil]=((matriz[fil][0]*(p0*a0/10))+(matriz[fil][1]*(p1*a1/10))+(matriz[fil][2]*(p2*a2/10))+(matriz[fil][3]*(p3*a3/10))); //ecuacion 
...
//  }
  ...
  Serial.print("HUM/p0  : "); Serial.println(p0);
  Serial.print("PM10/p1 : "); Serial.println(p1);
  Serial.print("PM2.5/p2: "); Serial.println(p2);
  Serial.print("UV/p3   : "); Serial.println(p3);
...
Serial.print("Muestras erradas:"); Serial.println(120-cont);
sum_umbral=0;
cont=0;
p0=0.87;
p1=0.87;
